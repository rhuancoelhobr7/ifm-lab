...
- **RE-rodar o `ExportGoldenIFM.mq5` na versão v1.10** (recompilar F7 antes!): a primeira rodada (v1.00, 2026-07-16) ancorou em HOJE — M30/H1/H4 caíram em julho/2026, fora dos dados da pesquisa, e pior: dentro do período selado. O v1.10 tem `InpAnchorBase` com default **2025-09-30 23:59** (fim da validação) — rodar com os defaults resolve. Depois: copiar os 5 CSVs de `MQL5\Files\IFM_golden\` para `data/raw/` e avisar; o `scripts/e03_paridade.py` (pronto, com guardas testadas) gera o relatório do C1.
