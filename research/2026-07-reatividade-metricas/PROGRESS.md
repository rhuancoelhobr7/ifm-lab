...
- **Rodar o `ExportGoldenIFM.mq5`** (`tools/export_golden/`, instruções no README de lá): compilar (F7), rodar na conta MetaQuotes-Demo com os defaults, copiar os 5 `golden_*.csv` de `MQL5\Files\IFM_golden\` para `data/raw/`. Com eles em mãos, o Claude roda a comparação e o P1 pode ser carimbado.
